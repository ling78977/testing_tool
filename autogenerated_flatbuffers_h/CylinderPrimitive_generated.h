...
struct CylinderPrimitive FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_bottom_scale(double _bottom_scale = 0.0) {
    return SetField<double>(VT_BOTTOM_SCALE, _bottom_scale, 0.0);
  }
  ...
  bool mutate_top_scale(double _top_scale = 0.0) {
    return SetField<double>(VT_TOP_SCALE, _top_scale, 0.0);
  }
...
inline CylinderPrimitive *GetMutableCylinderPrimitive(void *buf) {
  return ::flatbuffers::GetMutableRoot<CylinderPrimitive>(buf);
}

inline foxglove::CylinderPrimitive *GetMutableSizePrefixedCylinderPrimitive(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<foxglove::CylinderPrimitive>(buf);
}
