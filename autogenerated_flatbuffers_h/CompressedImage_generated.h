...
inline CompressedImage *GetMutableCompressedImage(void *buf) {
  return ::flatbuffers::GetMutableRoot<CompressedImage>(buf);
}

inline foxglove::CompressedImage *GetMutableSizePrefixedCompressedImage(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<foxglove::CompressedImage>(buf);
}
