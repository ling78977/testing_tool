...
struct LaserScan FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_start_angle(double _start_angle = 0.0) {
    return SetField<double>(VT_START_ANGLE, _start_angle, 0.0);
  }
  /// Bearing of last point, in radians
  double end_angle() const {
    return GetField<double>(VT_END_ANGLE, 0.0);
  }
  bool mutate_end_angle(double _end_angle = 0.0) {
    return SetField<double>(VT_END_ANGLE, _end_angle, 0.0);
  }
  ...
  ::flatbuffers::Vector<double> *mutable_ranges() {
    return GetPointer<::flatbuffers::Vector<double> *>(VT_RANGES);
  }
  /// Intensity of detections
  const ::flatbuffers::Vector<double> *intensities() const {
    return GetPointer<const ::flatbuffers::Vector<double> *>(VT_INTENSITIES);
  }
  ::flatbuffers::Vector<double> *mutable_intensities() {
    return GetPointer<::flatbuffers::Vector<double> *>(VT_INTENSITIES);
  }
...
inline LaserScan *GetMutableLaserScan(void *buf) {
  return ::flatbuffers::GetMutableRoot<LaserScan>(buf);
}

inline foxglove::LaserScan *GetMutableSizePrefixedLaserScan(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<foxglove::LaserScan>(buf);
}
