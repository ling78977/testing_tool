...
struct SceneEntityDeletion FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_type(foxglove::SceneEntityDeletionType _type = static_cast<foxglove::SceneEntityDeletionType>(0)) {
...
inline SceneEntityDeletion *GetMutableSceneEntityDeletion(void *buf) {
  return ::flatbuffers::GetMutableRoot<SceneEntityDeletion>(buf);
}

inline foxglove::SceneEntityDeletion *GetMutableSizePrefixedSceneEntityDeletion(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<foxglove::SceneEntityDeletion>(buf);
}
