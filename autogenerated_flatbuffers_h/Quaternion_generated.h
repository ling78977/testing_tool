...
struct Quaternion FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_w(double _w = 1.0) {
    return SetField<double>(VT_W, _w, 1.0);
  }
...
inline Quaternion *GetMutableQuaternion(void *buf) {
  return ::flatbuffers::GetMutableRoot<Quaternion>(buf);
}

inline foxglove::Quaternion *GetMutableSizePrefixedQuaternion(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<foxglove::Quaternion>(buf);
}
