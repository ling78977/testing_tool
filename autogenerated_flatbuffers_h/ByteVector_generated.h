...
inline ByteVector *GetMutableByteVector(void *buf) {
  return ::flatbuffers::GetMutableRoot<ByteVector>(buf);
}

inline foxglove::ByteVector *GetMutableSizePrefixedByteVector(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<foxglove::ByteVector>(buf);
}
