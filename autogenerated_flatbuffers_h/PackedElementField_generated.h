...
struct PackedElementField FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_type(foxglove::NumericType _type = static_cast<foxglove::NumericType>(0)) {
...
inline PackedElementField *GetMutablePackedElementField(void *buf) {
  return ::flatbuffers::GetMutableRoot<PackedElementField>(buf);
}

inline foxglove::PackedElementField *GetMutableSizePrefixedPackedElementField(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<foxglove::PackedElementField>(buf);
}
