...
struct ArrowPrimitive FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_shaft_length(double _shaft_length = 0.0) {
    return SetField<double>(VT_SHAFT_LENGTH, _shaft_length, 0.0);
  }
  /// Diameter of the arrow shaft
  double shaft_diameter() const {
    return GetField<double>(VT_SHAFT_DIAMETER, 0.0);
  }
  bool mutate_shaft_diameter(double _shaft_diameter = 0.0) {
    return SetField<double>(VT_SHAFT_DIAMETER, _shaft_diameter, 0.0);
  }
  /// Length of the arrow head
  double head_length() const {
    return GetField<double>(VT_HEAD_LENGTH, 0.0);
  }
  bool mutate_head_length(double _head_length = 0.0) {
    return SetField<double>(VT_HEAD_LENGTH, _head_length, 0.0);
  }
  /// Diameter of the arrow head
  double head_diameter() const {
    return GetField<double>(VT_HEAD_DIAMETER, 0.0);
  }
  bool mutate_head_diameter(double _head_diameter = 0.0) {
    return SetField<double>(VT_HEAD_DIAMETER, _head_diameter, 0.0);
  }
  /// Color of the arrow
...
inline ArrowPrimitive *GetMutableArrowPrimitive(void *buf) {
  return ::flatbuffers::GetMutableRoot<ArrowPrimitive>(buf);
}

inline foxglove::ArrowPrimitive *GetMutableSizePrefixedArrowPrimitive(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<foxglove::ArrowPrimitive>(buf);
}
