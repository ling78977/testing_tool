...
inline PoseInFrame *GetMutablePoseInFrame(void *buf) {
  return ::flatbuffers::GetMutableRoot<PoseInFrame>(buf);
}

inline foxglove::PoseInFrame *GetMutableSizePrefixedPoseInFrame(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<foxglove::PoseInFrame>(buf);
}
