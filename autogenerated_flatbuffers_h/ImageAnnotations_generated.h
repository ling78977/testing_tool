...
struct ImageAnnotations FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  ::flatbuffers::Vector<::flatbuffers::Offset<foxglove::CircleAnnotation>> *mutable_circles() {
    return GetPointer<::flatbuffers::Vector<::flatbuffers::Offset<foxglove::CircleAnnotation>> *>(VT_CIRCLES);
  }
  /// Points annotations
  ...
  ::flatbuffers::Vector<::flatbuffers::Offset<foxglove::PointsAnnotation>> *mutable_points() {
    return GetPointer<::flatbuffers::Vector<::flatbuffers::Offset<foxglove::PointsAnnotation>> *>(VT_POINTS);
  }
  /// Text annotations
  ...
  ::flatbuffers::Vector<::flatbuffers::Offset<foxglove::TextAnnotation>> *mutable_texts() {
    return GetPointer<::flatbuffers::Vector<::flatbuffers::Offset<foxglove::TextAnnotation>> *>(VT_TEXTS);
  }
...
inline ImageAnnotations *GetMutableImageAnnotations(void *buf) {
  return ::flatbuffers::GetMutableRoot<ImageAnnotations>(buf);
}

inline foxglove::ImageAnnotations *GetMutableSizePrefixedImageAnnotations(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<foxglove::ImageAnnotations>(buf);
}
