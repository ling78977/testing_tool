...
inline Point2 *GetMutablePoint2(void *buf) {
  return ::flatbuffers::GetMutableRoot<Point2>(buf);
}

inline foxglove::Point2 *GetMutableSizePrefixedPoint2(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<foxglove::Point2>(buf);
}
