...
inline SpherePrimitive *GetMutableSpherePrimitive(void *buf) {
  return ::flatbuffers::GetMutableRoot<SpherePrimitive>(buf);
}

inline foxglove::SpherePrimitive *GetMutableSizePrefixedSpherePrimitive(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<foxglove::SpherePrimitive>(buf);
}
